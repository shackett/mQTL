...
To confirm that this mQTL hotspot was governed by segregation of the engineered \textit{ura3} deletion, \textit{ura3}$\bigtriangleup$, this RM allele was inserted into a BY background and compounds differing between BY and BY\textit{ura3}$\bigtriangleup$ were assessed.  Using a two-tailed t-test, four compounds were found to differ between these two conditions at a 0.05 FDR.  The deletion resulted in the elevation of all four compounds, including two of the five compounds associated with this mQTL hotspot: orotate and orotidine-5'phosphate.  The other three compounds that were significantly associated by mQTL analysis were found to only weakly differ or were not ascertained in this confirmatory analysis, suggesting that we have less power to detect their divergence, and their magnitude is weaker.  The remaining two compounds that were elevated in BY\textit{ura3}$\bigtriangleup$, N-carbamoyl-aspartate and inosine diphosphate (IDP), were found to be quantifiable using mass-spectrometry subsequent to the analysis of segregants, so their global linkage could not be assessed, although their association to this locus is intriguing.  As a precursor of dihydroorotate, N-carbamoyl-aspartate is directly involved in pyrimidine synthesis, so its accumulation is not surprising.  In contrast, because IDP is a purine, its massive accumulation under a pyrimidine knockout, far greater than other purine metabolites, is unexpected and suggests a purpose.  Inosine has previously been shown to mediate pyrimidine scavenging \cite{Tozzi:1981ga} (its level is not associated with \textit{ura3}$\bigtriangleup$) while IMP is a known allosteric regulator of carbamoyl phosphate synthetase \cite{Trotta:1974ws}.  IDP's massive accumulation suggests an abundant pool of IMP allosterically driving flux into pyrimidine metabolism, or IDP may be working directly as a secondary mediator of one of these functions.  These results demonstrate that our approach can link changes in metabolite levels to a polymorphism (in this case, an engineered one) in a gene known to participate in the biosynthesis of the relevant metabolites.



\textbf{\textit{Slt2} and \textit{erc1} polymorphisms impact S-adenosyl-methionine levels}

The mQTL hot spot on chromosome VIII (m5) is linked to levels of 3 metabolites: thiamine, S-adenosyl-methionine (SAM), and S-adenosyl-homocysteine (SAH) (Table S1). The overlap among 95\% confidence intervals of the mQTLs for these compounds covers a region containing all or part of 14 genes (Figure S3). None of the genes in this region have a known connection with the sulfur-assimilation pathway. We identified \textit{slt2} as a candidate for further evaluation due to the presence of a two amino acid indel polymorphism between BY and RM in a polyglutamine track; variation in the number of glutamines in this track has previously been implicated in stress response \cite{deLlanos:2010jt}.
